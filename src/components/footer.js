            ...
            <div className="row py-4">
              <div className="col-12 col-lg-4 text-start ">
                ...
                <p>
                  ...
                  Facebook:{" "}
                  <a
                    href="https://www.facebook.com/minhduc.le.182"
                    target="_blank"
                  >
                    Lê Minh Đức
                  </a>
                ...
                <p className="mb-0">
                  ...
                  Email:{" "}
                  <a href="mailto:minhduc8a2.1@gmail.com">
              ...
              <div className="col-12 col-lg-4 text-start">
                ...
                <p className="mb-0">
                  ...
                  Đây là nơi chia sẻ suy nghĩ, cảm nhận, kinh nghiệm từng trải
                  của tác giả. Hy vọng sẽ mang lại nhiều thông tin hữu ích cho
                  quý vị.
                </p>
              </div>
            </div>
